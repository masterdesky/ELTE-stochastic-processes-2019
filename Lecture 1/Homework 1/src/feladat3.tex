...
Határozzuk meg a $t = N_{\tau}$ idő alatti elmozdulás és az elmozdulás négyzetének átlagát, $\left< x_{t} \right>$-t és $\left< x_{t}^{2} \right>$-t}
\\ \\
...
\quest{Vizsgáljuk a fenti problémát $p_{+} = 4p_{-}$ esetre és számítsuk ki az $\left< x_{t} \right>$, $\left< x_{t}^{2} \right>$ és a $\left< x_{t}^{2} \right> - \left< x_{t} \right>^{2}$ átlagokat!}
\\ \\
