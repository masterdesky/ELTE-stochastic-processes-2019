...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor = cyan,
    pdftitle={Stochastic Processes - 8-9.},
...
\newcommand\rrt{Véletlen Rekurzív Fa }
\newcommand\apm{Anti-Preferenciális Modell }
\newcommand\rrtt{Véletlen Rekurzív Fát }
\newcommand\apmt{Anti-Preferenciális Modellt }
